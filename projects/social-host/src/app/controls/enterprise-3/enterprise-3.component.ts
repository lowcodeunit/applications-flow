...
@Component({
    selector: 'lcu-enterprise-3',
    templateUrl: './enterprise-3.component.html',
    styleUrls: ['./enterprise-3.component.scss'],
})
export class Enterprise3Component implements OnInit {
